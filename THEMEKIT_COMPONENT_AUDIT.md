...
- [ ] **⏭ PR-2b — Adjustable/paging VoiceOver:** Diff (drag → `accessibilityAdjustableAction`), PagingCarousel (paging), Splitter (divider label) — bundled with the RTL-geometry pass.
