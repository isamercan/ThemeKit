...
enum ComponentRegistry {
    static let all: [ComponentEntry] = [
        ...
        .knob("DataTable", .organisms, demo: DataTableDemo(), usage: #"DataTable(columns: [.init("Hotel") { $0.hotel }], rows: rows)"#),
        ...
        .knob("Upload", .organisms, demo: UploadDemo(), usage: #"Upload(files: files, onPick: { }, onRemove: { _ in })"#),
