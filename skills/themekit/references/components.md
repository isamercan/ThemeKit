...
`.a11yID()` `.a11yLabel()` `.action()` `.alertCount()` `.alignment()` `.allowHalf()` `.arrows()` `.autoplay()` `.axis()` `.backButton()` `.badge()` `.badgeColor()` `.badgeShape()` `.badgeStyle()` `.barHeight()` `.buttonTitle()` `.cascade()` `.characterLimit()` `.clearable()` `.color()` `.colors()` `.components()` `.cornerRadius()` `.customSize()` `.dashboard()` `.debounce()` `.density()` `.description()` `.dimension()` `.divider()` `.dots()` `.editable()` `.errorText()` `.exists()` `.expands()` `.fade()` `.fileName()` `.fillColor()` `.fullWidth()` `.gap()` `.gradient()` `.hasInfo()` `.highlighted()` `.hint()` `.icon()` `.iconBackground()` `.iconCircleSize()` `.iconForeground()` `.imageMaxHeight()` `.indeterminate()` `.indicator()` `.infoMessages()` `.infos()` `.inputs()` `.interactive()` `.jumper()` `.large()` `.leadingImage()` `.leadingSelection()` `.lineWidth()` `.loading()` `.locale()` `.loop()` `.marks()` `.maxResults()` `.maxTags()` `.maxValue()` `.message()` `.meta()` `.minHeight()` `.multilineTitle()` `.muteToggle()` `.muted()` `.nodeEnabled()` `.number()` `.onChangeEnd()` `.onClear()` `.onClose()` `.onInfo()` `.onRate()` `.onReviewTap()` `.onSearch()` `.onValueChange()` `.placeholder()` `.prefix()` `.presence()` `.primaryAction()` `.progressLabel()` `.radioStyle()` `.range()` `.rating()` `.ringColor()` `.searchable()` `.secondaryAction()` `.selected()` `.sentiment()` `.shape()` `.showTotal()` `.showsLabel()` `.showsValueTooltip()` `.simple()` `.size()` `.starSize()` `.status()` `.step()` `.stepText()` `.steps()` `.style()` `.subtitle()` `.successSegment()` `.suffix()` `.suggestionEnabled()` `.symbol()` `.tapToToggle()` `.titleSize()` `.trailing()` `.trailingIcon()` `.trend()` `.truncateSubtitle()` `.type()` `.unit()` `.valueFormat()` `.valueLabel()` `.variant()` `.videoProgress()` `.window()`
