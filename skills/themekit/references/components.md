...
`.a11yID()` `.a11yLabel()` `.alertCount()` `.alignment()` `.allowHalf()` `.arrows()` `.autoplay()` `.axis()` `.backButton()` `.badge()` `.badgeColor()` `.badgeShape()` `.barHeight()` `.cascade()` `.clearable()` `.color()` `.colors()` `.components()` `.customSize()` `.dashboard()` `.debounce()` `.density()` `.description()` `.divider()` `.dots()` `.editable()` `.errorText()` `.exists()` `.expands()` `.fade()` `.fillColor()` `.fullWidth()` `.gap()` `.gradient()` `.hasInfo()` `.highlighted()` `.hint()` `.icon()` `.iconBackground()` `.iconCircleSize()` `.iconForeground()` `.imageMaxHeight()` `.indeterminate()` `.indicator()` `.infoMessages()` `.infos()` `.inputs()` `.interactive()` `.jumper()` `.large()` `.leadingImage()` `.leadingSelection()` `.lineWidth()` `.loading()` `.locale()` `.loop()` `.marks()` `.maxResults()` `.maxTags()` `.maxValue()` `.message()` `.meta()` `.multilineTitle()` `.muteToggle()` `.muted()` `.nodeEnabled()` `.number()` `.onChangeEnd()` `.onInfo()` `.onRate()` `.onReviewTap()` `.onSearch()` `.onValueChange()` `.placeholder()` `.prefix()` `.primaryAction()` `.progressLabel()` `.radioStyle()` `.range()` `.rating()` `.ringColor()` `.searchable()` `.secondaryAction()` `.selected()` `.sentiment()` `.shape()` `.showTotal()` `.showsLabel()` `.showsValueTooltip()` `.simple()` `.size()` `.starSize()` `.status()` `.step()` `.steps()` `.style()` `.subtitle()` `.successSegment()` `.suffix()` `.suggestionEnabled()` `.symbol()` `.tapToToggle()` `.titleSize()` `.trailing()` `.trailingIcon()` `.trend()` `.truncateSubtitle()` `.type()` `.unit()` `.valueFormat()` `.valueLabel()` `.variant()` `.window()`
