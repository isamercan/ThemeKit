...
`.a11yID()` `.a11yLabel()` `.action()` `.alertCount()` `.alignment()` `.allowHalf()` `.arrows()` `.autoplay()` `.axis()` `.backButton()` `.badge()` `.badgeColor()` `.badgeShape()` `.badgeStyle()` `.barHeight()` `.buttonTitle()` `.calloutStyle()` `.cascade()` `.characterLimit()` `.clearable()` `.color()` `.colors()` `.components()` `.cornerRadius()` `.ctaTitle()` `.customSize()` `.dashboard()` `.dashed()` `.debounce()` `.density()` `.description()` `.digitCount()` `.dimension()` `.divider()` `.dots()` `.editable()` `.errorText()` `.exists()` `.expands()` `.fade()` `.fileName()` `.fillColor()` `.fullWidth()` `.gap()` `.gaugeStyle()` `.gradient()` `.hasInfo()` `.highlighted()` `.hint()` `.icon()` `.iconBackground()` `.iconCircleSize()` `.iconForeground()` `.imageMaxHeight()` `.indeterminate()` `.indicator()` `.infoMessages()` `.infos()` `.inputs()` `.interactive()` `.jumper()` `.large()` `.leadingImage()` `.leadingSelection()` `.lineWidth()` `.loading()` `.locale()` `.loop()` `.marks()` `.maxResults()` `.maxTags()` `.maxValue()` `.message()` `.meta()` `.minHeight()` `.mode()` `.multilineTitle()` `.muteToggle()` `.muted()` `.nodeEnabled()` `.number()` `.onChangeEnd()` `.onClear()` `.onClose()` `.onInfo()` `.onRate()` `.onReviewTap()` `.onSearch()` `.onValueChange()` `.pending()` `.placeholder()` `.prefix()` `.presence()` `.primaryAction()` `.progressLabel()` `.radioStyle()` `.range()` `.rating()` `.resend()` `.reversed()` `.ringColor()` `.searchable()` `.secondaryAction()` `.secure()` `.selected()` `.sentiment()` `.shape()` `.showTotal()` `.showsIcon()` `.showsLabel()` `.showsValue()` `.showsValueTooltip()` `.simple()` `.size()` `.starSize()` `.status()` `.step()` `.stepText()` `.steps()` `.style()` `.subtitle()` `.successSegment()` `.suffix()` `.suggestionEnabled()` `.symbol()` `.tapToToggle()` `.titleAlign()` `.titleSize()` `.trailing()` `.trailingIcon()` `.trend()` `.truncateSubtitle()` `.type()` `.unit()` `.valueFormat()` `.valueLabel()` `.variant()` `.videoProgress()` `.window()`
