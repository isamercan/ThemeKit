...
- `Checkbox(label, isChecked:)` — Figma "Control Items" → Checkboxes. · modifiers: `.type()`, `.indeterminate()`, `.alignment()`, `.controlPlacement()`, `.lineThrough()`, `.customSize()`, `.accent()`, `.infoMessages()`, `.a11yID()`
